...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      <ThemeSwitcher
        itemClassName="clms-nav-item"
        labelClassName="clms-nav-label"
      />

      <button
        className="clms-nav-item logout"
